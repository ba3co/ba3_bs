      ...
      child: Wrap(
          ...
          children: [
            if (chequesSearchController.isNew)
              Obx(() {
                return AppButton(
                  ...
                  height: 20,
                  isLoading:
                      chequesDetailsController.saveChequesRequestState.value ==
                          RequestState.loading,
                  color: chequesDetailsController.isChequesSaved.value
                      ? Colors.green
                      : Colors.blue.shade700,
                  onPressed: chequesDetailsController.isChequesSaved.value
                      ? () {}
                      : () async {
                          await chequesDetailsController
                              .saveCheques(chequesType);
                        },
            ...
            if (!chequesSearchController.isNew) ...[
              ...
              Obx(() {
                return AppButton(
                  isLoading: chequesDetailsController
                          .deleteChequesRequestState.value ==
                      RequestState.loading,
                  onPressed: () {
              ...
              AppButton(
                onPressed: () {
                  chequesDetailsController.launchEntryBondWindow(
                      chequesModel, context);
                },
              ...
              if (!chequesDetailsController.isRefundPay!)
                AppButton(
                  ...
                  title: chequesDetailsController.isPayed!
                      ? AppStrings.paymentDelete.tr
                      : AppStrings.pay.tr,
              ...
              if (chequesDetailsController.isPayed!)
                AppButton(
                  onPressed: () {
                    chequesDetailsController.launchPayEntryBondWindow(
                        chequesModel, context);
                  },
                  ...
                  onPressed: () {
                    chequesDetailsController.isRefundPay!
                        ? chequesDetailsController
                            .deleteRefundPayCheques(chequesModel)
                        : chequesDetailsController
                            .refundPayCheques(chequesModel);
                  },
                  title: chequesDetailsController.isRefundPay!
                      ? AppStrings.deleteRefund.tr
                      : AppStrings.refund.tr,
              ...
              if (chequesDetailsController.isRefundPay!)
                AppButton(
                  onPressed: () {
                    chequesDetailsController.launchRefundPayEntryBondWindow(
                        chequesModel, context);
                  },
