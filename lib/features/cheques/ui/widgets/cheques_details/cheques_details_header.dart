...
class ChequesDetailsHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  TextAndExpandedChildField(label: 'الحالة ', child:    Container(
      ...
      child: Center(child: Text(ChequesStatus.notPaid.label,style: const TextStyle(color: Colors.white),)),
    ),);
  }
}
