...
class BillExport extends ExportServiceBase<BillModel> {
    ...
    return {
      "Bill": itemsModels.map((billModel) {
        return <String, dynamic>{
          "B": {
            "BillTypeGuid":
                _billTypeGuide(billModel.billTypeModel.billTypeLabel!),
            ...
            "BillStoreGuid":
                billModel.billTypeModel.accounts?[BillAccounts.store]?.id,
          ...
          "Items": {
            "I": billModel.items.itemList
                .map((item) => {
                      ...
                      "StorePtr": billModel
                          .billTypeModel.accounts?[BillAccounts.store]?.id,
                      "Note": item.itemName,
                      "BonusDisc": 0,
                      ...
                      "ClassPrice": 0,
                      "ExpireProdDate":
                          "1-1-1980,1-1-1980", // Replace with actual expiration dates if available
                      "LengthWidthHeight": "0,0,0,0",
                      "Guid": item.itemGuid,
                      "VatRatio": _calcVatRatio(
  ...
  String _billTypeGuide(String billLabel) =>
      BillType.byLabel(billLabel).typeGuide;
