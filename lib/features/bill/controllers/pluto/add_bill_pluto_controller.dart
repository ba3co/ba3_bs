...
//
//   @override
//   void restoreCurrentCell(PlutoGridStateManager stateManager) => _gridService.restoreCurrentCell(stateManager,  b);
//
//   @override
//   void onInit() {
//     super.onInit();
...
//       _gridService.updateInvoiceValuesByTotal(total, quantity,b);
