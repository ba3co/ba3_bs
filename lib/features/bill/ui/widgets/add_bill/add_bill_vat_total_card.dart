...
class AddBillVatTotalCard extends StatelessWidget {
  final double width;
  final AddBillPlutoController controller;

  const AddBillVatTotalCard({super.key, required this.width, required this.controller});
