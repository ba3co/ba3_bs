...
//                   onChanged: (_) {
//                     // patternController.editPatternModel?.copyWith(patPartnerRatio: double.tryParse(_) ?? 0.0);
//                   },
//                 ),
//               ),
//             ],
...
//                   onSubmitted: (text) async {},
//                   onChanged: (_) {
//                     //  patternController.editPatternModel?.copyWith(patPartnerCommission: double.tryParse(_) ?? 0.0);
//                   },
//                 ),
//               ),
//             ],
