    ...
    return Form(
      ...
      child: Wrap(
        ...
        children: [
          ...
          SearchableAccountField(label: 'المواد', textEditingController: patternController.materialsController),
          SearchableAccountField(label: 'الحسميات', textEditingController: patternController.discountsController),
          SearchableAccountField(label: 'الاضافات', textEditingController: patternController.additionsController),
          SearchableAccountField(label: 'النقديات', textEditingController: patternController.cachesController),
          SearchableAccountField(label: 'الهدايا', textEditingController: patternController.giftsController),
          SearchableAccountField(
              label: 'مقابل الهدايا', textEditingController: patternController.exchangeForGiftsController),
          SearchableAccountField(label: 'المستودع', textEditingController: patternController.storeController),
        ],
      ),
    );
  }
