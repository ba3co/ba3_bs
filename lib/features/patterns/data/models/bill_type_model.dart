...
class BillTypeModel extends HiveObject with EquatableMixin {
  ...
  void printDetails() {
    ...
    _printField('shortName', shortName);
    _printField('fullName', fullName);
    _printField('latinShortName', latinShortName);
    _printField('latinFullName', latinFullName);
    _printField('billTypeLabel', billTypeLabel);
    _printField('color', color);
