...
import '../interfaces/database_without_result_base.dart';

class DataSourceRepositoryWithoutResult<T> {
  final DatabaseWithoutResultBase<T> _dataSource;

  DataSourceRepositoryWithoutResult(this._dataSource);
