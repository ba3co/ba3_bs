...
class QueryableSavableRepository<T> extends RemoteDataSourceRepository<T> {
  ...
  QueryableSavableRepository(this._queryableSavableDatasource)
      : super(_queryableSavableDatasource);
  ...
  Future<Either<Failure, List<T>>> saveAll(List<T> items) async {
    try {
      ...
      log('Error in saveAll: $e',
          stackTrace: stackTrace, name: 'QueryableSavableRepository saveAll');
  ...
  Future<Either<Failure, List<T>>> fetchWhere(
    ...
    try {
      ...
      log('Error in fetchWhere: $e',
          ...
          name: 'QueryableSavableRepository fetchWhere');
      return Left(ErrorHandler(e).failure); // Return error
    }
  }
}
