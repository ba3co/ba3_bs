...
abstract class FetchWhereCapability<T> {
  Future<List<T>> fetchWhere(
      {required List<QueryFilter>? queryFilters, DateFilter? dateFilter});
}

abstract class FilterableDatasource<T> extends RemoteDatasourceBase<T>
    implements FetchWhereCapability<T> {
