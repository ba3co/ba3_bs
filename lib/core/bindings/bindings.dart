...
import '../../features/materials/service/material_image_upload_service.dart';
...
class AppBindings extends Bindings {
  ...
  Future<void> dependencies() async {
    ...
    final IRemoteStorageService<String> remoteStorageService =
        read<IRemoteStorageService<String>>();

    lazyPut(MaterialImageUploadService(remoteStorageService));
  ...
  void _initializeLazyControllers(_Repositories repositories) {
    ...
    lazyPut(PrintingController(PrinterManager(
        ts: TranslationService(
            repositories.translationRepo)) /*repositories.translationRepo*/));
