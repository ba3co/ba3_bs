import 'package:ba3_bs/core/services/firebase/implementations/firebase_repo_impl.dart';
...
import '../../features/invoice/services/invoice/bill_json_export.dart';
...
class AppBindings extends Bindings {
  ...
  void dependencies() {
    ...
    final IFirebaseRepository<BillTypeModel> patternsFirebaseRepo = FirebaseRepositoryImpl(
      PatternsDataSource(firestore),
    );

    // Instantiate InvoicesDataSource and FirebaseRepositoryConcrete of BillModel
    final IFirebaseRepository<BillModel> billsFirebaseRepo = FirebaseRepositoryImpl(
