...
//     //if new status is approved and selectedPayType is dueDelivery then create PaymentVoucher bond
//     //(من selectedBillAccount الى حساب الصندوق مبلغ والى حساب اخر يتم اختياره مبلغ اخر)
//     //if new status is pending and selectedPayType is bankTransferDelivery then create PaymentVoucher bond
//     //(من حساب يتم اختياره الى حساب اخر يتم اختياره  )
//     //if new status is approved and selectedPayType is bankTransferDelivery then create PaymentVoucher bond
//     //(من حساب الصندوق الى حساب اخر يتم اختياره  )

//     //الرجاء عرض المعلومات ضمن  dialog overlay مع اضافة ازرار تاكيد وتراجع
//   }
...
//       plutoController: billDetailsPlutoController,
//       billTypeModel: billTypeModel);*/
// }  و import 'package:ba3_bs/core/constants/app_strings.dart';
// import 'package:ba3_bs/core/helper/extensions/bill/bill_pattern_type_extension.dart';
// import 'package:ba3_bs/core/helper/extensions/date_time/date_time_extensions.dart';
...
//                           ? [billDetailsController.selectedStatus.value]
//                           : billDetailsController
//                               .selectedStatus.value.nextStatuses,
//                       itemLabelBuilder: (status) => status.value,
//                       onChanged: (selectedStatus) {
//                         billDetailsController.updateStatus(selectedStatus);
//                       },
